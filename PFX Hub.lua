...
local Bloxburg = Meteor:CreateWindow({
    Name = "Prime FrostyX HubV2",
    LoadingTitle = "Prime FrostyX",
    LoadingSubtitle = "by GhostZxy & GhostRxy",
    ConfigurationSaving = { Enabled = true, FolderName = "MeteorLite", FileName = "BloxFruit" }
})
